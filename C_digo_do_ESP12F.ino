...
//WiFi
const char* SSID = "WiFi ESP8266";                // SSID / nome da rede WiFi que deseja se conectar
const char* PASSWORD = "TheCakeIsALie";   // Senha da rede WiFi que deseja se conectar
WiFiClient wifiClient;                        
 
//MQTT Server
const char* BROKER_MQTT = "iot.eclipse.org"; //URL do broker MQTT que se deseja utilizar
int BROKER_PORT = 8266;                      // Porta do Broker MQTT

#define ID_MQTT  "REL01"            //Informe um ID unico e seu. Caso sejam usados IDs repetidos a ultima conexão irá sobrepor a anterior. 
#define TOPIC_PUBLISH "RELBotao1"    //Informe um Tópico único. Caso sejam usados tópicos em duplicidade, o último irá eliminar o anterior.
